...
if($result) {
    header("Location: index.php?status=New user has been created");
} else {
...
<body>
        ...
        <div class="container">
            ...
            <p class="text-muted text-center mt-3">Register a new user by filling the forms</p>
                ...
                <form action="" method="post">
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="e.g Victor">
                        </div>
                        <div class="col">
                            <label class="form-label">Email</label>
                            <input type="email" class="form-control" name="email" placeholder="e.g victor@mail.com">
                        </div>
                        <div class="col">
